...
class TestExceptions(unittest.TestCase):
    ...
    def test_2(self):
        result = calculate(B1=1, B2=0.01, p=0, omega=0.01, Qw=300*Q_SI_multiplier, QoilStart=50*Q_SI_multiplier, QoilEnd=351*Q_SI_multiplier, QoilStep=50*Q_SI_multiplier, wn=25*micrometre, Ln=15*micrometre, H=20*micrometre, wcont=30*micrometre, wdisp=40*micrometre, wout=70*micrometre, is_ionic=False)
    ...
    def test_3(self):
        ...
        result = calculate(B1=1, B2=0.78, p=1, Kvisc=0.0294, EtaZero=0.0294, EtaInf=0.0326, n=2, omega=0.01, Qw=50*Q_SI_multiplier, QoilStart=50*Q_SI_multiplier, QoilEnd=301*Q_SI_multiplier, QoilStep=50*Q_SI_multiplier, wn=20*micrometre, Ln=20*micrometre, H=20*micrometre, wcont=30*micrometre, wdisp=40*micrometre, wout=70*micrometre, is_ionic=False)
